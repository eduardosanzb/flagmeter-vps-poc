...
Begin with Phase 0 context sync. After gathering context, introduce the assessment (2-3 sentences), list the five dimensions in one line, and ask for the user's name/company. Use today's date automatically — do not ask the user for it.
