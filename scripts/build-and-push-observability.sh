...
# Compose file to use
COMPOSE_FILE="${COMPOSE_FILE:-coolify.observability.swarm.yaml}"
...
# Start build process
log_info "Starting Observability Stack build and push workflow..."
...
# Build images
log_info "Building observability images (Prometheus, Grafana)..."
...
log_success "Observability stack build and push completed successfully!"
echo ""
